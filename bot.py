...
def start(message):
    ...
    bot.edit_message_text(chat_id=message.chat.id, message_id=sent_message.message_id, text=f'''Hi {name} Welcome To Saoud Checker.⌛''', reply_markup=mes)
...
def start(call):
    ...
    bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=f'''Hi {name} Welcome To Saoud Checker.⌛''', reply_markup=mes)
...
Bot Devoleper : Your Uncle Saoud [@aaka8h] 
     """, reply_markup=markup)
...
Bot Devoleper : Your Uncle Saoud [@aaka8h]  """, reply_markup=markup)
...
def respond_to_vbv(message):
    def my_function():
        ...
        try:
            ...
            msg = f'''<b>𓆩𝗞𝗲𝘆 𝗥𝗲𝗱𝗲𝗲𝗺𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆𓆪! 👑🌪:  𝐃ev : 『@aaka8h』  »»{timer}
{typ}</b>'''
...
def save_to_file(text):
    if os.path.exists(f'Generated_Cards_saoud.txt'):
        os.remove('Generated_Cards_saoud.txt')
    with open('Generated_Cards_saoud.txt', 'w') as file:
        file.write(text)
...
def send_sc_messages(message):
    ...
    if input_data.isdigit() and len(input_data) >= 6:  # نفترض أن البين يتكون من 6 أرقام على الأقل
        ...
        file_path = f"Generated_Cards_{count}_{bin}_saoud.txt"
...
def main(message):
	  ...
	  "timer": "none",
			...
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/aaka8h")
            ...
            with open("combo.txt", 'r') as file:
                ...
                for cc in lino:
                    ...
                    bot.edit_message_text(chat_id=call.message.chat.id,
                                          ...
                                          𝘾𝙝𝙚𝙘𝙠 𝘽𝙮『@aaka8h』''', reply_markup=mes)
            ...
            with open("combo.txt", 'r') as file:
                ...
                for cc in lino:
                    ...
                    bot.edit_message_text(chat_id=call.message.chat.id,
                                          message_id=call.message.message_id,
                                          text=f'''𝙋𝙡𝙚𝙖𝙨𝙚 𝙒𝙖𝙞𝙩 𝙒𝙝𝙞𝙡𝙚 𝙔𝙤𝙪𝙧 𝘾𝙖𝙧𝙙𝙨 𝘼𝙧𝙚 𝘽𝙚𝙞𝙣𝙜 𝘾𝙝𝙚𝙘𝙠 𝘼𝙩 𝙏𝙝𝙚 𝙂𝙖𝙩𝙚𝙬𝙖𝙮 {gate}
                                          𝘽𝙤𝙩 𝘽𝙮『@aaka8h』''', reply_markup=mes)
